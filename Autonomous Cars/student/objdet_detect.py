...
def load_configs_model(model_name="darknet", configs=None):
    ...
    elif model_name == 'fpn_resnet': # We load resnet pretrained which downloaded from readme file given classroom
        ####### 1806A004_S3_EX1-3 START #######     
        #######
        print("student task 1806A004_S3_EX1-3")
...
def detect_objects(input_bev_maps, model, configs):
    ...
    with torch.no_grad():  
        ...
        if 'darknet' in configs.arch:
            ...
            ####### 1806A004_S3_EX1-5 START #######     
            #######
            print("student task 1806A004_S3_EX1-5")
            ...
            #######
            ####### 1806A004_S3_EX1-5 END #######     

            

    ####### 1806A004_S3_EX2 START #######     
    #######
    # Extract 3d bounding boxes from model response
    print("student task 1806A004_S3_EX2")
    objects = [] 
